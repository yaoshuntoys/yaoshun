const rawSiteUrl = (
  process.env.NEXT_PUBLIC_SITE_URL || "https://www.yaoshuntoys.com"
).trim();
...
export const googleAdsLeadConversionSendTo = (
  process.env.NEXT_PUBLIC_GOOGLE_ADS_LEAD_CONVERSION_SEND_TO || ""
).trim();
export const googleAdsContactConversionSendTo = (
  process.env.NEXT_PUBLIC_GOOGLE_ADS_CONTACT_CONVERSION_SEND_TO || ""
).trim();
