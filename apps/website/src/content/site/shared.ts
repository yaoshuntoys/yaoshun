...
export const siteSeo = {
  defaultKeywords: {
    en: [
      ...
      "eco-friendly toy material supplier",
      "plastic tubing and profile supplier",
      "custom plastic manufacturing",
      "custom mold development manufacturer",
      "precision plastic extrusion manufacturer",
      "ai toy manufacturer",
      "medical tubing extrusion supplier",
      "non-phthalate plastic product manufacturer",
    ],
    zh: [
      "东莞市尧顺科技有限公司",
      "东莞市尧顺科技",
