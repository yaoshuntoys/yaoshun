...
export const seoKeywordPools = {
  company: {
    en: [
      ...
      "Dongguan source toy factory",
      "Chashan Dongguan toy factory",
...
export const siteSeo = {
  defaultKeywords: {
    en: [
      ...
      "STEM building toy manufacturer",
      "DIY building toy supplier",
      "custom plastic toy manufacturer",
      "precision injection molding manufacturer",
      "plastic extrusion manufacturer",
      "PVC PU ABS PC nylon tubing manufacturer",
      ...
      "sample-based processing",
      "drawing-based processing",
      "RoHS REACH toy supplier",
      "EN71 ASTM F963 toy manufacturer",
      "private label toy manufacturer",
    ],
    zh: [
